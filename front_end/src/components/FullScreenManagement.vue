<template>
    <div class="management-layout">
        ...
        <div class="sidebar">
            ...
            <!-- 可滚动的部门树 -->
            <div class="sidebar-tree" style="flex: 1; overflow-y: auto; overflow-x: hidden; min-height: 0; height: auto; max-height: none;">
                <arco-tree blockNode :data="departmentTree" :expanded-keys="expandedKeys"
                    ...
                    :virtual="false" :height="undefined">
...
.sidebar {
    ...
    height: 100% !important; /* 使用父容器的完整高度 */
    overflow: hidden !important; /* 确保侧边栏整体不滚动 */
}
...
.sidebar-tree {
    ...
    margin: 0 16px 20px !important; /* 增加底部边距确保下沿可见 */
    min-height: 0 !important; /* 确保可以收缩 */
    padding-bottom: 16px !important; /* 容器底部内边距 */
    ...
    /* 仅针对此页面的tree组件做最小必要的修改 */
    :deep(.arco-tree) {
        padding-bottom: 50px !important; /* 增加更多底部内边距 */
    }
    
    :deep(.arco-tree-node:last-child) {
        margin-bottom: 20px !important; /* 最后节点额外间距 */
    }
}
...
/* 强制覆盖任何可能的样式冲突 */
.management-layout .sidebar .sidebar-tree {
    flex: 1 !important;
...
/* 确保本页面树容器样式正确 */
.management-layout .sidebar-tree {
    overflow-y: scroll !important;
    overflow-x: hidden !important;
    max-height: none !important;
    height: auto !important;
