      ...
      <div class="content">
        ...
        <div class="nav-info">
          ...
          <div class="handle-btn">
            ...
            <arco-button v-if="navIndex === 0" type="outline" class="arco-add-link" @click="showUrlUpload">
              {{ home.addUrl }}
            </arco-button>
            <arco-button v-if="navIndex === 0" type="outline" class="arco-manage-members" @click="showPermissionDialog">
              <TeamOutlined />
              权限设置
            </arco-button>
            <arco-button v-if="navIndex === 1" type="outline" class="arco-upload" @click="showEditQaSet">
              {{ home.inputQa }}
            </arco-button>
