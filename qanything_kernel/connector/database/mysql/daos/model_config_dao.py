    ...
    def create_table(self):
        ...
        query = """
            CREATE TABLE IF NOT EXISTS ModelConfig (
                ...
                creativity FLOAT DEFAULT 1.0,
                thinking_depth FLOAT DEFAULT 1.0,
                expression_style FLOAT DEFAULT 1.0,
                vocabulary_richness FLOAT DEFAULT 1.0,
                token_limit FLOAT DEFAULT 1.0,
                reasoning_strength VARCHAR(20) DEFAULT '中',
