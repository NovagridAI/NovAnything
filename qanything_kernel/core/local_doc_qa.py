...
class LocalDocQA:
    ...
    # 会话管理相关方法
    def add_conversation(self, user_id: str, title: str, kb_ids: List[str], is_favorite: bool = False) -> str:
        """添加会话
        ...
        Returns:
            会话ID
        """
        return self.milvus_summary.add_conversation(user_id, title, kb_ids, is_favorite)
    ...
    def get_conversations(self, user_id: str, is_favorite: Optional[bool] = None, 
        ...
        # 获取会话列表
        conversations = self.milvus_summary.get_conversations(user_id, is_favorite, limit, offset)
        
        # 获取会话总数
        total = self.milvus_summary.count_conversations(user_id, is_favorite)
    ...
    def get_conversation_by_id(self, conversation_id: str) -> Optional[Dict[str, Any]]:
        ...
        Returns:
            会话详情
        """
        return self.milvus_summary.get_conversation_by_id(conversation_id)
    ...
    def update_conversation(self, conversation_id: str, title: Optional[str] = None,
        ...
        Returns:
            是否更新成功
        """
        return self.milvus_summary.update_conversation(conversation_id, title, is_favorite, kb_ids)
    ...
    def toggle_favorite_conversation(self, conversation_id: str) -> bool:
        ...
        """
        # 先切换状态
        success = self.milvus_summary.toggle_favorite_conversation(conversation_id)
        
        if success:
            # 获取最新状态
            conversation = self.milvus_summary.get_conversation_by_id(conversation_id)
            if conversation:
                return True, conversation['is_favorite']
    ...
    def delete_conversation(self, conversation_id: str) -> bool:
        ...
        Returns:
            是否删除成功
        """
        return self.milvus_summary.delete_conversation(conversation_id)
