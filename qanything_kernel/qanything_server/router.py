...
from qanything_kernel.qanything_server.model_config import create_model_config, update_model_config, get_model_config, list_model_configs, delete_model_config, set_active_model_config, get_active_model_config
...
def register_routes(app: Sanic):
    ...
    app.add_route(get_available_departments_for_user_move, "/api/user/available_departments", methods=['POST'])  # tags=["获取用户移动可选部门"]
    ...
    app.add_route(get_available_parent_departments, "/api/department/available_parents", methods=['POST'])  # tags=["获取可选父部门列表"]
    ...
    app.add_route(set_active_model_config, "/api/model/set_active", methods=['POST'])  # tags=["设置活跃模型"]
    app.add_route(get_active_model_config, "/api/model/get_active", methods=['GET'])  # tags=["获取活跃模型"] 