...
# 是否加载本地tokenizer
LOAD_LOCAL_TOKENIZERS = False

# 硅基流动API配置
USE_SILICON_FLOW_EMBEDDING = False  # 是否使用硅基流动API进行embedding
SILICON_FLOW_API_URL = "https://api.siliconflow.cn/v1/embeddings"  # 硅基流动API的URL
SILICON_FLOW_API_KEY = "sk-nyaakphkkjtbmsfdbrjhevxkyymfliwunxusspttlcstvbov"  # 硅基流动API密钥
SILICON_FLOW_MODEL = "netease-youdao/bce-embedding-base_v1"  # 硅基流动API使用的模型
